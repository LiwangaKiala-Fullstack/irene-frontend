    ...
    <section class="container-fluid py-5 px-lg-5" style="background: #FCFAF7; min-height: 100vh; padding-top: 140px !important;">
      <div class="row align-items-center py-5">
        ...
        <div class="col-12 col-lg-6 pe-lg-5 mb-5 mb-lg-0">
          <span class="text-uppercase small willow ls-5 d-block mb-3 fw-bold font-monospace" style="font-size: 0.65rem; letter-spacing: 3px;">About the Artist</span>
          ...
          <p class="text-secondary small mb-4" style="line-height: 1.8; font-family: sans-serif;">
          ...
          <div class="border-start border-secondary border-2 ps-3 mt-4">
            <span class="small fw-bold text-uppercase d-block tracking-wider font-monospace" style="font-size: 0.7rem;">Public & Private Commissions</span>
            <span class="small text-muted">Executing large-scale spatial installations designed to transform public architecture landscapes.</span>
          </div>
        </div>
        
        <!-- Right Column: Fine Art Canvas Frame -->
